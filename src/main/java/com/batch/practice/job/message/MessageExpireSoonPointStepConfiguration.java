...
import com.batch.practice.job.listener.InputExpireSoonPointAlarmCriteriaDateStepListener;
import com.batch.practice.message.Message;
import com.batch.practice.point.ExpiredPointSummary;
...
public class MessageExpireSoonPointStepConfiguration {
    ...
    public RepositoryItemReader<ExpiredPointSummary> messageExpireSoonPointItemReader(
        ...
        return new RepositoryItemReaderBuilder<ExpiredPointSummary>()
                ...
                .methodName("sumByBeforeCriteriaDate")
                .pageSize(1000)
